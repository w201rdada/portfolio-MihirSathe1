...
library(magrittr)
readLines('https://www.zotero.org/api/users/4672380/items/top?start=0&limit=null&format=bibtex&itemKey=6NR243IT&key=vzrPJYnHujxWhzRIn8Lm4kaH&v=1') %>% writeLines('references.bib')
```
